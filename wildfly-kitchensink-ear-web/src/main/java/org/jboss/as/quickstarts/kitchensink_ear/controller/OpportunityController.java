...
import org.jboss.as.quickstarts.kitchensink_ear.service.OpportunityFacade;
...
public class OpportunityController {
    ...
    public Collection<Opportunity> getOpportunities() {
        try {
            return opportunityFacade.findAllOpportunities();
        } catch (Throwable e) {
            log.log(Level.SEVERE, "Failed to load opportunities", e);
